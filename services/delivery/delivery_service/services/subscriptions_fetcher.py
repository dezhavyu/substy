...
from delivery_service.schemas.subscriptions import SubscribersPage
...
class SubscriptionsFetcherService:
    ...
    async def iter_subscribers(self, topic_id: UUID) -> AsyncIterator[UUID]:
