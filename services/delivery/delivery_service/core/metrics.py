...
class MetricsRegistry:
    def __init__(self) -> None:
        self._lock = Lock()
        self.delivery_attempts_created_total = 0
    ...
    def inc_attempts_created(self, value: int = 1) -> None:
        with self._lock:
            self.delivery_attempts_created_total += value
    ...
    def render_prometheus(self) -> str:
        with self._lock:
            lines = [
                ...
                f"delivery_attempts_created_total {self.delivery_attempts_created_total}",
