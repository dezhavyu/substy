...
from notifications_service.core.exceptions import AppError
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def handle_request_validation(request: Request, _: RequestValidationError) -> JSONResponse:
        return JSONResponse(
            status_code=422,
            content=_payload(request, "validation_error", "Invalid request"),
        )
